...
let cc = Config.sessionName.replace(/Quenn-Ziyav;;;/gi, "").replace(/Secktor;;;/gi, ""); // Dont Remove "Secktor;;;" So that You Can Use Secktor Qr too in your bot
...
setTimeout(() => {
    ...
    async function main() {
        ...
        catch {console.log('Could not connect with Mongodb.\nPlease visit https://github.com/LUCKYSERSKBA/Quenn-Ziyav')}
    }
    main()
    //========================================================================================================================================
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "/assets/Xlicon.png"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "/assets/Xlicon.png"); //ur logo pic
