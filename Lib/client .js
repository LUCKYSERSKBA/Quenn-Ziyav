...
setTimeout(() => {
    ...
    async function main() {
        ...
        catch {console.log('Could not connect with Mongodb.\nPlease visit https://github.com/salmanytofficial/XLICON-MD')}
    }
    main()
    //========================================================================================================================================
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "/assets/Ziyav.png"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "/assets/Ziyav.png"); //ur logo pic
        ...
        Void.serializeM = (citel) => smsg(Void, citel, store)
            ...
            Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    let integrate  = "_Ziyav has been integrated._\n_Total Plugins :"
...
app.listen(port, () => console.log(`Ziyav Server listening on port http://localhost:${port}!`));
